# 원자 안정성 시뮬레이터 (Atomic Stability Survival)

실제 동위원소(Isotope) 데이터에 기반하여 원자의 안정성을 시뮬레이션하는 교육용 게임입니다. 플레이어는 양성자, 중성자, 전자 수를 조절하여 원자를 만들고, 해당 원소의 실제 반감기와 안정성에 따라 생존 시간을 결정받습니다.
...
본 프로젝트는 Vercel 배포에 완벽히 최적화되어 있습니다.
